...
最後更新：2026-08-27（**第 38 批：移除「延期完成 2 次以上」篩選選項**，併回「有延期完成」；
⚠️ 徽章的「2 次以上轉紅」刻意保留。
...
| `?v=` | **`20260827006`**（第 38 批；`005`＝第 37 批、`004`＝第 36 批、`003`＝第 35 批、`002`＝第 34 批、`001`＝第 33 批。`20260824014` 是第 32 批：002~005＝第 27 批、006＝28、007~009＝29、010~011＝30、012＝31，中途的建置不算不同版本） |

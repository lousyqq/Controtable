...
最後更新：2026-08-24（**第 32 批：投影模式改成「只有精簡模式＋需求列表頁才能開」，
切到其他頁面自動回復正常版面**（使用者要求），無 SQL 腳本。
同一天做完第 27（A、C）／28（B）／29（D、E、F、G）／30／31 批 ——
**2026-08-22 那份 UI/UX 體檢清單至此全部清空**）
